class MainMenu extends Phaser.Scene {
    ...
    preload () {
        this.load.image("tilesetPokemon", "../jeux/tournois/assets/maps/tilesets/tileset_pokemon.png");
        this.load.tilemapTiledJSON("MainMenu", "../jeux/tournois/assets/maps/tilemaps/MainMenu.json");
