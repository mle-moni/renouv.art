class Level1 extends Phaser.Scene {
    ...
    preload () {
        this.load.image("tilesetMario", "../jeux/tournois/assets/maps/tilesets/marioTileset.png");
        this.load.tilemapTiledJSON("Level1", "../jeux/tournois/assets/maps/tilemaps/Level1.json");
