class Ville_ext_3 extends Phaser.Scene {
    constructor () {
        super ({
            key: "Ville_ext_3"
        });
    ...
    preload () {
        ...
        this.load.tilemapTiledJSON("Ville_ext_3", "../jeux/catharsis/assets/maps/tilemaps/Ville_ext_3.json");
        ...
        this.portesInfos = [
            {
                key: "portes_bois1", 
                src: "../jeux/catharsis/assets/sprites/portes/portes_bois1.png", 
                size: { frameWidth: 96, frameHeight: 90 }, 
                idle: {name: "idle_porte_bois1", frames: { frame1: 0, frame2: 4 }, speed: 1},
                anim: {name: "open_porte_bois1", frames: { start: 0, end: 3 }, speed: 10}
            },
            {
                key: "portes_modern", 
                src: "../jeux/catharsis/assets/sprites/portes/portes_modern.png", 
                size: { frameWidth: 36, frameHeight: 54 }, 
                idle: {name: "idle_porte_modern", frames: { frame1: 0, frame2: 4 }, speed: 1},
                anim: {name: "open_porte_modern", frames: { start: 0, end: 3 }, speed: 10}
            }
        ];
