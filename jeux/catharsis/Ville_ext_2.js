class Ville_ext_2 extends Phaser.Scene {
    constructor () {
        super ({
            key: "Ville_ext_2"
        });
    ...
    preload () {
        ...
        this.load.tilemapTiledJSON("Ville_ext_2", "../jeux/catharsis/assets/maps/tilemaps/Ville_ext_2.json");
        ...
        this.load.image('fumee_1', '../jeux/catharsis/assets/sprites/fumee_1.png');
        ...
        this.portesInfos = [
            {
                key: "portes_usine1", 
                src: "../jeux/catharsis/assets/sprites/portes/portes_usine1.png", 
                size: { frameWidth: 64, frameHeight: 64 }, 
                idle: {name: "idle_porte_usine1", frames: { frame1: 0, frame2: 4 }, speed: 1},
                anim: {name: "open_porte_usine1", frames: { start: 0, end: 3 }, speed: 10}
            }
        ];
        ...
        this.persosInfos = [
            {
                key: "femme2",
                src: "../jeux/catharsis/assets/sprites/ville_depart/femme2.png",
            ...
            {
                key: "homme1",
                src: "../jeux/catharsis/assets/sprites/ville_depart/homme1.png",
                size: { frameWidth: 32, frameHeight: 48 },
    ...
    create () {
        ...
        self.particles["fumee_1"] = self.add.particles("fumee_1");
        self.particles["fumee_1"].setDepth(12);
        self.emitters = [];
        ...
        for ( let y = 0; y < self.map.layers[3].data.length; y++) {
            for (let x = 0; x < self.map.layers[3].data[y].length; x++) {
                ...
                } else if (self.map.layers[3].data[y][x].index === 1845) {
                    self.emitters.push( self.particles["fumee_1"].createEmitter({
                        x: 16*x +8,
                        y: 16*y +8,
                        speed: { min: 0, max: -10 },
                        gravityY: -50,
